...
EVAL_FREQ = 250000
EVAL_EPISODES = 1000
LOGDIR = "my_ppo"  # moved to zoo afterwards.
...
# PPO takes a gym environment and finds some distribution that models the action to take base on current env.obs
# No need to tell it what policy to use, that is what it seeks to find
...
eval_callback = EvalCallback(Monitor(env), best_model_save_path=LOGDIR, log_path=LOGDIR, eval_freq=EVAL_FREQ,
